...
import struxtureCategory from '@/components/icons/struxture-category'
...
export const pricingCards = [
  {
    title: 'Starter',
    description: 'Try out our software for free',
    price: 'Free',
    duration: '',
